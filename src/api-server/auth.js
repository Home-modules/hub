 ...
 */
export function loginUser(username, password, device, ip) {
    username = Object.keys(users).find(u => u.toLowerCase() == (username === null || username === void 0 ? void 0 : username.toLowerCase()));
...
export function checkAuthToken(token) {
    ...
    const login = (_a = logins[username]) === null || _a === void 0 ? void 0 : _a.find(t => t.token === tk);
    if (!login) {
        return null;
    }
...
export function logOutSession(token) {
    var _a;
    const [username, tk] = token.split(':');
    if ((_a = logins[username]) === null || _a === void 0 ? void 0 : _a.some(t => t.token === tk)) {
 ...
 */
export function logOutOtherSessions(token) {
    const [username, tk] = token.split(':');
...
export function getSessionsCount(token) {
    var _a;
    const [username] = token.split(':');
    return ((_a = logins[username]) === null || _a === void 0 ? void 0 : _a.length) || 0;
}
/**
 ...
 */
export function changePassword(token, oldP, newP) {
    const [username] = token.split(':');
 ...
 */
export function changeUsername(token, newUsername) {
    const [username, tk] = token.split(':');
 ...
 */
export function usernameExists(token, username) {
    const [requester] = token.split(':');
    if (requester.toLowerCase() === username.toLowerCase()) {
        return !!users[username];
    }
    else {
        return Object.keys(users).some(u => u.toLowerCase() == (username === null || username === void 0 ? void 0 : username.toLowerCase()));
    }
}
export function getSessions(token) {
    var _a;
    const [username, tk] = token.split(':');
    return ((_a = logins[username]) === null || _a === void 0 ? void 0 : _a.map(t => ({
...
function require24HoursSession(token) {
    var _a;
    const [username, tk] = token.split(':');
    ...
    const session = (_a = logins[username]) === null || _a === void 0 ? void 0 : _a.find(t => t.token === tk);
