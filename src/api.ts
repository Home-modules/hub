...
export namespace HMApi {
    ...
    export namespace T {
        ...
        /** A UI color */
        export type UIColor = 'accent'|'red'|'orange'|'yellow'|'green'|'blue'|'purple'|'pink'|'brown';
    }
}